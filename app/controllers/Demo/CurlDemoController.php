...
class CurlDemoController extends \BaseController
{
    ...
    {
        //初始化变量
        $cookie_file = 'tmp.cookie';   #cookie地址
        ...
        //$userData = 'user=18581877799&pwd=YAB4894286';
        ...
        curl_setopt($curlLogin, CURLOPT_COOKIEJAR, $cookie_file);       #获取cookie并存储
        ...
        //curl_setopt($curlLogin, CURLOPT_SSL_VERIFYHOST, 2);             #检查公用名是否存在，是否与主机名匹配
        ...
        $login_url = 'http://cd.iduoqian.com/333vgohappy/?c=admin&a=default';
        curl_setopt($curlLogin, CURLOPT_URL, $login_url);               #设置访问的URL
